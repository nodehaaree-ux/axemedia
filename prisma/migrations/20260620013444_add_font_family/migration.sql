...
INSERT INTO "new_CompanySettings" ("address", "email", "id", "invoiceFooter", "logoSize", "logoUrl", "name", "offerFooter", "phone", "primaryColor", "tagline", "taxId", "updatedAt", "website") SELECT "address", "email", "id", "invoiceFooter", "logoSize", "logoUrl", "name", "offerFooter", "phone", "primaryColor", "tagline", "taxId", "updatedAt", "website" FROM "CompanySettings";
